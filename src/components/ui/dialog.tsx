    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          isFullScreen &&
            "w-full md:min-w-[80vh] min-h-[80vh] bg-secondary-background border-4 rounded-base shadow-none p-0 overflow-hidden",
          className
        )}
        {...props}
      >
        ...
        {!noCloseButton && (
          <Button asChild variant="neutral" size="icon">
            <DialogPrimitive.Close className="absolute right-4 top-4 rounded-base opacity-100 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4">
              <X className="size-4" />
